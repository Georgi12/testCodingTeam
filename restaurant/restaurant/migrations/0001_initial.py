# Generated by Django 4.1.2 on 2022-10-06 21:30
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('additional', models.ManyToManyField(blank=True, related_name='additional_from', to='project.food', verbose_name='Дополнительные товары')),
                ('category', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='food', to='project.foodcategory', verbose_name='Раздел меню')),
            ],
            options={
                'abstract': False,
            },
